...
var useSoundPlayer = (props) => {
  ...
  const [volume, setVolumeState] = (0, import_react2.useState)(1);
  ...
  const addToQueue = (0, import_react2.useCallback)(
    async (message) => {
      ...
      try {
        const blob = (0, import_hume2.convertBase64ToBlob)(message.data);
  ...
  const setVolume = (0, import_react2.useCallback)(
    (newLevel) => {
...
var useEncoding = () => {
  ...
  const getStream = (0, import_react5.useCallback)(
    async (audioConstraints = {}) => {
      try {
        const stream = await (0, import_hume4.getAudioStream)(audioConstraints);
  ...
  const connect = (0, import_react8.useCallback)(
    async (options = {}) => {
      ...
      if (permission === "denied") {
        ...
        const error2 = { type: "mic_error", message };
        updateError(error2);
      ...
      try {
        ...
        const error2 = { type: "socket_error", message };
        updateError(error2);
        return Promise.reject(new Error(message));
      }
      try {
